        ...
        <template>
            ...
            >
                ...
                <el-table-column
                    ...
                    label="名称"
                ></el-table-column>
                <el-table-column show-overflow-tooltip align="center" prop="createUserName" label="创建人"></el-table-column>
                <el-table-column show-overflow-tooltip align="center" prop="createTime" label="创建时间"></el-table-column>
                <el-table-column show-overflow-tooltip align="center" prop="updateUserName" label="更新人"></el-table-column>
                <el-table-column show-overflow-tooltip align="center" prop="updateTime" label="更新时间"></el-table-column>
                <el-table-column
                    show-overflow-tooltip
                    label="操作"
                    v-if="permitList.queryReportCategory || permitList.editReportCategory || permitList.deleteReportCategory"
                    align="center"
                    width="220"
                >
...
export default {
    ...
    computed: {
        ...mapState('webkit', ['reportConfigMenuList']),
    },
    methods: {
        ...mapActions('webkit', ['QUERY_REPORT_CONFIG_MENU']),
        /**
         * 获取菜单
         */
         requestMenus() {
            this.QUERY_REPORT_CONFIG_MENU().then((data) => {
                // 固定的报表页加进去
                const indexObj = [{ parent: null, id: 'report', name: '报表', url: '/report/index', children: data, fullPath: '报表', parentPath: '', noArgUrl: null }];
