        ...
        <template slot="search">
            ...
            >
                ...
                <audaque-table-search-item title="类别名称">
                    <el-select clearable v-model.trim="param.name" maxlength="100" placeholder="请选择类别名称">
                        <el-option
...
export default {
    ...
    computed: {
        ...mapState('webkit', ['reportCategoryList', 'reportCategoryAll']),
    },
    methods: {
        ...mapActions('webkit', ['REPORT_CATEGORY_LIST', 'DELETE_REPORT_CATEGORY', 'QUERY_REPORT_CATEGORY_All']),
        initData() {
