...
export default {
    ...
    methods: {
        ...
        onOpen() {
            ...
            this.htmlCode = beautify.html(this.htmlCode, beautifierConf.html);
            this.jsCode = beautify.js(this.jsCode, beautifierConf.js);
            this.cssCode = beautify.css(this.cssCode, beautifierConf.html);
