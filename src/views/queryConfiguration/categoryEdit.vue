                ...
                <el-row>
                    <el-col :span="23">
                        <el-form-item label="编码" prop="code">
                            <el-input v-model.trim="form.code" :maxlength="userMaxLength" show-word-limit></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="23">
                        <el-form-item label="名称" prop="name">
                            <el-input v-model.trim="form.name" maxlength="100" show-word-limit></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
